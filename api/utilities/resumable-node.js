...
module.exports = resumable = function(temporaryFolder){
  ...
  $.post = function(req, callback){
    ...
    const chunkNumber = req.param('resumableChunkNumber');
    const chunkSize = req.param('resumableChunkSize');
    const totalSize = req.param('resumableTotalSize');
    const identifier = cleanIdentifier(req.param('resumableIdentifier'));
    const filename = req.param('resumableFilename');
    const original_filename = req.param('resumableIdentifier');
